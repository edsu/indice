...
For turnkey Docker Compose overlays that wire this up (Basic auth or GitHub SSO), see [Deploy indice](/indice/docs/guides/deploy/#management-over-the-network).
